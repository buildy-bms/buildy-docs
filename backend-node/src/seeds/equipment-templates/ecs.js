...
`.trim(),
  points: [
    ...
    { slug: 'temp.boucle_retour', label: 'Température boucle de retour', dataType: 'Mesure', direction: 'read', unit: '°C', position: 30, nature: 'Numérique', techName: 'Return_Water_Temp_R' },
    ...
    { slug: 'energie.consommee', label: 'Énergie consommée', dataType: 'Mesure', direction: 'read', unit: 'kWh', position: 50, nature: 'Numérique', techName: 'Active_Energy_Index_R' },
    { slug: 'volume.tire', label: 'Volume d\'eau tiré', dataType: 'Mesure', direction: 'read', unit: 'L', position: 60, nature: 'Numérique', techName: 'Volume_Index_R' },
    ...
    { slug: 'alarme.surchauffe', label: 'Alarme surchauffe', dataType: 'Alarme', direction: 'read', position: 80, nature: 'Booléen', techName: 'System_Fault_R' },
    { slug: 'alarme.legionellose_echec', label: 'Échec cycle anti-légionellose', dataType: 'Alarme', direction: 'read', position: 90, nature: 'Booléen', techName: 'System_Fault_R' },
    { slug: 'cmd.declencher_legionellose', label: 'Déclencher cycle anti-légionellose', dataType: 'Commande', direction: 'write', position: 100, nature: 'Booléen', techName: 'On_Off_W' },
