      ...
      <div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden divide-y divide-gray-100">
          ...
          <div class="flex items-center gap-3 px-4 py-3 bg-emerald-50">
            <FontAwesomeIcon :icon="['fas', 'circle-user']" class="w-6 h-6 text-emerald-700 shrink-0" />
          ...
          <div v-for="g in data.grants" :key="g.user_id" class="flex items-center gap-3 px-4 py-3">
            ...
            >
              <FontAwesomeIcon :icon="['fas', 'pencil']" v-if="g.role === 'write'" class="w-3 h-3" />
      ...
      <div class="border-t border-gray-200 pt-4">
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2">
            ...
            >
              <FontAwesomeIcon :icon="['fas', 'eye']" class="w-3.5 h-3.5 inline-block -mt-0.5 mr-1" />Lecture
            </button>
            <button
              type="button"
              @click="newRole = 'write'"
            ...
            >
              <FontAwesomeIcon :icon="['fas', 'pencil']" class="w-3.5 h-3.5 inline-block -mt-0.5 mr-1" />Écriture
            </button>
          </div>
        </div>
