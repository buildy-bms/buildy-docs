...
`.trim(),
  points: [
    ...
    { slug: 'energie.active_partielle', label: 'Énergie active partielle (index réinitialisable)', dataType: 'Mesure', direction: 'read', unit: 'kWh', position: 20 },
    { slug: 'puissance.active', label: 'Puissance active instantanée', dataType: 'Mesure', direction: 'read', unit: 'kW', techName: 'P_ACTIVE', nature: 'Numérique', position: 30 },
    { slug: 'puissance.reactive', label: 'Puissance réactive instantanée', dataType: 'Mesure', direction: 'read', unit: 'kVAR', position: 40 },
    { slug: 'mesure.tension_l1', label: 'Tension phase 1', dataType: 'Mesure', direction: 'read', unit: 'V', position: 50 },
    { slug: 'mesure.tension_l2', label: 'Tension phase 2', dataType: 'Mesure', direction: 'read', unit: 'V', position: 60 },
    { slug: 'mesure.tension_l3', label: 'Tension phase 3', dataType: 'Mesure', direction: 'read', unit: 'V', position: 70 },
    { slug: 'mesure.courant_l1', label: 'Courant phase 1', dataType: 'Mesure', direction: 'read', unit: 'A', position: 80 },
    { slug: 'mesure.courant_l2', label: 'Courant phase 2', dataType: 'Mesure', direction: 'read', unit: 'A', position: 90 },
    { slug: 'mesure.courant_l3', label: 'Courant phase 3', dataType: 'Mesure', direction: 'read', unit: 'A', position: 100 },
    { slug: 'mesure.frequence', label: 'Fréquence', dataType: 'Mesure', direction: 'read', unit: 'Hz', position: 110 },
    { slug: 'mesure.cos_phi', label: 'Facteur de puissance', dataType: 'Mesure', direction: 'read', position: 120 },
    { slug: 'alarme.defaut_communication', label: 'Défaut communication', dataType: 'Alarme', direction: 'read', position: 130 },
  ],
};
