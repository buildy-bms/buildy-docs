...
`.trim(),
  points: [
    ...
    { slug: 'etat.niveau', label: 'Niveau ventilation effectif (1, 2, 3...)', dataType: 'État', direction: 'read', position: 15, techName: 'Fan_Level_R', nature: 'Enum' },
    { slug: 'mesure.vitesse', label: 'Vitesse ventilation effective', dataType: 'Mesure', direction: 'read', unit: '%', position: 20, isOptional: true, techName: 'Fan_Speed_R', nature: 'Numérique' },
    { slug: 'mesure.debit_souffle', label: 'Débit soufflé', dataType: 'Mesure', direction: 'read', unit: 'm³/h', position: 30, isOptional: true, techName: 'Supply_Air_Flow_R', nature: 'Numérique' },
    { slug: 'mesure.debit_extrait', label: 'Débit extrait', dataType: 'Mesure', direction: 'read', unit: 'm³/h', position: 40, isOptional: true, nature: 'Numérique' },
    ...
    { slug: 'alarme.encrassement_filtre', label: 'Encrassement filtre', dataType: 'Alarme', direction: 'read', position: 60, isOptional: true, techName: 'Filter_Fault_R', nature: 'Booléen' },
    ...
    { slug: 'cmd.niveau', label: 'Commande niveau ventilation (discret)', dataType: 'Commande', direction: 'write', position: 110, techName: 'Fan_Level_W', nature: 'Enum' },
    { slug: 'cmd.vitesse', label: 'Commande vitesse ventilation (continue)', dataType: 'Commande', direction: 'write', unit: '%', position: 120, isOptional: true, techName: 'Fan_Speed_W', nature: 'Numérique' },
  ],
};
