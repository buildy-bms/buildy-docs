...
const SYSTEM_PROMPT_LIBRARY = [
  ...
  `- R175-1 : definitions. Le 4° definit le systeme technique de batiment : chauffage, refroidissement, ventilation, production d'eau chaude sanitaire, eclairage integre, automatisation et controle, production d'electricite sur site (ou combinaison de ces systemes).`,
  ...
  `    3° interoperabilite avec les systemes techniques (protocole normalise, API ou passerelle).`,
  `    4° arret manuel des systemes relies depuis la GTB + gestion autonome (les systemes relies continuent de fonctionner si la GTB est arretee). PAS "reporting" : le reporting n'est pas une exigence R175-3.`,
  `- R175-4 : verifications periodiques par un prestataire externe ou un personnel interne competent, encadrees par des consignes ecrites. C'est un ARTICLE reglementaire, JAMAIS une "norme".`,
  `- R175-5 : formation de l'exploitant au fonctionnement et au parametrage de la GTB.`,
  `- R175-5-1 : inspection periodique de la GTB, a l'initiative du proprietaire (inspecteur independant recommande par la FAQ n° 30, non impose).`,
  `- R175-6 : regulation automatique de la temperature par piece ou, si cela est justifie, par zone chauffee (chauffage seulement).`,
  ``,
  `NOTATION FIXE :`,
...
const SYSTEM_PROMPT_SYNTHESIS = [
  ...
  `jointe au rapport d'audit de conformite au decret BACS (articles R175-1 a`,
  `R175-6 du code de la construction et de l'habitation). Cet audit est un`,
  `constat de conformite, distinct de l'inspection periodique R175-5-1`,
  `(organisee a l'initiative du proprietaire).`,
  ``,
  `Style imperatif :`,
  `- Francais professionnel, technique mais accessible (le client n'est pas`,
  `  forcement expert GTB). Definir les sigles (GTB, ECS...) a leur premiere`,
  `  apparition. Ecrire « decret BACS », jamais « decret R175 ».`,
  `- Ton neutre, a la troisieme personne : jamais de « vous », « votre »,`,
  `  « nous » ni d'imperatif adresse au lecteur (la note est imprimee dans`,
  `  le rapport PDF lu par le client final).`,
  `- Bienveillant, oriente solution. Jamais culpabilisant.`,
  `- Termine par une phrase sobre sur l'accompagnement que Buildy peut`,
  `  apporter pour mettre en oeuvre les actions, sans appel commercial appuye.`,
  ``,
  `Regles strictes :`,
  ...
  `  d'extrapoler.`,
  `- /!\\ REGLE D'OR TERNAIRES /!\\ Les champs metier suivants ont TROIS etats :`,
  `  managed_by_bms, wired, meets_r175_3_p4, meets_r175_3_p4_autonomous,`,
  `  is_backup, communicating (compteurs), bms.present, audit_existing_af_status.`,
  `  true/1 = repondu oui, false/0 = repondu non, NULL = PAS ENCORE REPONDU.`,
  `  JAMAIS ecrire "X equipements integres GTB, Y non integres" sans regarder`,
  `  combien sont a null. Si plus de 30 pourcent des managed_by_bms sont a null,`,
  `  ecrire "L'integration GTB des equipements reste a qualifier avant de pouvoir`,
  `  conclure" plutot qu'un chiffre faux. Idem pour les compteurs (communicating,`,
  `  managed_by_bms). Si bms.present === null, ne pas affirmer la presence ou`,
  `  l'absence de GTB — dire que la question n'a pas ete repondue.`,
  `- Reste fidele au plan d'action genere : ne minimise pas les ecarts`,
  `  bloquants, ne dramatise pas non plus. Les nombres d'actions sont ceux de`,
  `  stats (actions_blocking, actions_major, actions_minor, reserves,`,
  `  informations) : les reprendre exactement, sans recompter.`,
  `- action_items_open[].kind = 'reserve' : obligation a respecter (maintenance`,
  `  de la GTB par un contrat ou un personnel interne competent, R175-4 ; export`,
  `  regulier des donnees depuis Hyperveez en supervision Buildy Essentials,`,
  `  R175-3 1°). Une reserve ne rend pas le site non conforme : s'il ne reste`,
  `  que des reserves, le site est « conforme au decret BACS, sous reserves ».`,
  `  Les presenter clairement comme des obligations a respecter.`,
  `- kind = 'information' : exemption (regle des 5 %, FAQ ministerielle n° 16,`,
  `  non opposable) ou point de vigilance : ni ecart ni action.`,
  `- Une action mineure dont la description porte une « Condition`,
  `  d'application » vise un systeme dont le raccordement n'est exige que sous`,
  `  condition (batiment existant) : la presenter comme une recommandation.`,
  ...
  `  · R175-3 3° interoperabilite (protocole normalise, API ou passerelle)`,
  `  · R175-3 4° arret manuel depuis la GTB + fonctionnement autonome des`,
  `    systemes relies lorsque la GTB est arretee`,
  `  · R175-3 dernier alinea : mise a disposition des donnees au gestionnaire et aux exploitants`,
  `  · R175-4 verifications periodiques par un prestataire externe ou un`,
  `    personnel interne competent, encadrees par des consignes ecrites`,
  `  · R175-5 formation de l'exploitant au fonctionnement et au parametrage (attestee)`,
  `  · R175-5-1 inspection periodique a l'initiative du proprietaire (tiers`,
  `    independant recommande, non impose)`,
  `  · R175-6 regulation automatique de la temperature par piece ou, si`,
  `    justifie, par zone chauffee (chauffage seulement)`,
...
async function assistAuditSynthesis(auditDump) {
  ...
  const userPrompt = [
    ...
    ``,
    `=== INSTRUCTION ===`,
    `Redige la note de synthese a partir des donnees ci-dessus. ` +
    `4 a 6 paragraphes courts en HTML Tiptap. Aucun titre marketing. Pas ` +
    `d'invention. Ton neutre, a la troisieme personne. Termine sur une phrase ` +
    `sobre sur l'accompagnement possible de Buildy pour les actions prioritaires.`,
    ``,
...
const SYSTEM_PROMPT_FAQ_BASE = [
  ...
  `- **Marketing punch implicite** quand pertinent : « pour un parc multi-sites », « sans complexité », « avant l'échéance 2030 ». Pas de superlatifs vides.`,
...
async function assistFaqRewriteTitle({ article }) {
  ...
  const systemText = [
    ...
    `- **Marketing punch implicite** quand pertinent : "pour un parc multi-sites", "sans complexité", "avant l'échéance 2030". Pas de superlatifs vides ("puissant", "complet", "performant").`,
