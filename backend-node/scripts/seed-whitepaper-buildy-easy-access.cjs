...
const SUBTITLE = 'Tous vos bâtiments sur une carte.<br>Un clic, vous êtes dans la GTB du site.<br>Quelle que soit la marque.';
...
<p class="chapter-bridge">Voilà à quoi ça doit ressembler.</p>
...
<div class="solution-card solution-card-compact">
  ...
  <p class="brands-line">Peu importe la marque installée sur le site (Schneider EcoStruxure, Distech, Niagara, PCVue et les autres), tout passe par le même portail.</p>
