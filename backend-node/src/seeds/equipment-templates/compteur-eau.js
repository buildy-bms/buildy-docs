...
`.trim(),
  points: [
    ...
    { slug: 'mesure.debit_instantane', label: 'Débit instantané', dataType: 'Mesure', direction: 'read', unit: 'm³/h', position: 30, isOptional: true },
    { slug: 'alarme.fuite_potentielle', label: 'Alarme fuite potentielle (consommation continue)', dataType: 'Alarme', direction: 'read', position: 40, isOptional: true },
    { slug: 'alarme.defaut_communication', label: 'Défaut communication', dataType: 'Alarme', direction: 'read', position: 50, isOptional: true },
  ],
};
