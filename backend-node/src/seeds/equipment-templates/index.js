...
module.exports = [
  ...
  require('./drv'),
  require('./unite-interieure-drv'),
  require('./pompe-a-chaleur'),
  require('./circuit-chauffage'),
  require('./regulateur-chaufferie'),
  require('./thermostat'),
  require('./rooftop'),
  ...
  require('./contacteur-pilote'),
  require('./borne-irve'),
  require('./portail-motorise'),
  require('./contact-tor'),
  require('./disjoncteur-of'),
  require('./disjoncteur-sd'),
