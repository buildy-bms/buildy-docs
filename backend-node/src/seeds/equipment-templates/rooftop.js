...
`.trim(),
  points: [
    ...
    { slug: 'alarme.compresseur', label: 'Défaut compresseur', dataType: 'Alarme', direction: 'read', position: 110, isOptional: true, nature: 'Booléen' },
    { slug: 'alarme.batterie_chauffe', label: 'Défaut batterie de chauffage', dataType: 'Alarme', direction: 'read', position: 120, isOptional: true, nature: 'Booléen' },
    { slug: 'alarme.communication', label: 'Défaut communication', dataType: 'Alarme', direction: 'read', position: 130, nature: 'Booléen' },
    ...
    { slug: 'consigne.confort_reduit', label: 'Consigne confort/réduit', dataType: 'Consigne', direction: 'write', position: 230, isOptional: true, nature: 'Numérique' },
  ],
};
