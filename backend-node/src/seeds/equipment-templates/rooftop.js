...
`.trim(),
  points: [
    ...
    { slug: 'temp.exterieure', label: 'Température extérieure (air neuf)', dataType: 'Mesure', direction: 'read', unit: '°C', position: 30 },
    ...
    { slug: 'temp.ambiante', label: 'Température ambiante mesurée', dataType: 'Mesure', direction: 'read', unit: '°C', position: 55, isOptional: true },
    { slug: 'debit.soufflage', label: 'Débit air soufflé', dataType: 'Mesure', direction: 'read', unit: 'm³/h', position: 58, isOptional: true },
    { slug: 'puissance.frigo', label: 'Puissance frigorifique', dataType: 'Mesure', direction: 'read', unit: 'kW', position: 60, isOptional: true },
    { slug: 'puissance.chauffe', label: 'Puissance de chauffe', dataType: 'Mesure', direction: 'read', unit: 'kW', position: 70, isOptional: true },
    { slug: 'consigne.chauffage_effective', label: 'Consigne chauffage effective', dataType: 'Mesure', direction: 'read', unit: '°C', position: 75 },
    { slug: 'consigne.climatisation_effective', label: 'Consigne climatisation effective', dataType: 'Mesure', direction: 'read', unit: '°C', position: 80 },
    ...
    { slug: 'alarme.compresseur', label: 'Défaut compresseur', dataType: 'Alarme', direction: 'read', position: 110, isOptional: true },
    { slug: 'alarme.batterie_chauffe', label: 'Défaut batterie de chauffage', dataType: 'Alarme', direction: 'read', position: 120, isOptional: true },
    ...
    { slug: 'cmd.mode', label: 'Commande mode (chaud/froid/auto)', dataType: 'Commande', direction: 'write', position: 210, isOptional: true },
    { slug: 'consigne.chauffage', label: 'Consigne chauffage', dataType: 'Consigne', direction: 'write', unit: '°C', position: 220 },
    { slug: 'consigne.climatisation', label: 'Consigne climatisation', dataType: 'Consigne', direction: 'write', unit: '°C', position: 225 },
    { slug: 'consigne.confort_reduit', label: 'Consigne confort/réduit', dataType: 'Consigne', direction: 'write', position: 230, isOptional: true },
  ],
};
