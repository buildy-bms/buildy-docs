...
`.trim(),
  points: [
    ...
    { slug: 'temp.ambiance', label: 'Température ambiante mesurée', dataType: 'Mesure', direction: 'read', unit: '°C', position: 20, techName: 'Ambient_Temp_R', nature: 'Numérique' },
    { slug: 'consigne.effective', label: 'Consigne effective', dataType: 'Mesure', direction: 'read', unit: '°C', position: 30, techName: 'Setpoint_Temp_R', nature: 'Numérique' },
    { slug: 'etat.mode_chaud_froid', label: 'Mode chaud/froid', dataType: 'État', direction: 'read', position: 40, techName: 'Heat_Cool_Mode_R', nature: 'Booléen' },
    { slug: 'etat.mode_hvac', label: 'Mode HVAC (auto/éco/confort/...)', dataType: 'État', direction: 'read', position: 50, techName: 'HVAC_Control_Mode_R', nature: 'Enum' },
    ...
    { slug: 'mesure.vitesse_ventilation', label: 'Vitesse ventilation effective', dataType: 'Mesure', direction: 'read', unit: '%', position: 70, isOptional: true, nature: 'Numérique' },
    ...
    { slug: 'cmd.mode_chaud_froid', label: 'Commande mode chaud/froid', dataType: 'Commande', direction: 'write', position: 210, techName: 'Heat_Cool_Mode_W', nature: 'Booléen' },
    { slug: 'cmd.mode_hvac', label: 'Commande mode HVAC', dataType: 'Commande', direction: 'write', position: 220, techName: 'HVAC_Control_Mode_W', nature: 'Enum' },
    { slug: 'cmd.niveau_ventilation', label: 'Commande niveau de ventilation', dataType: 'Commande', direction: 'write', position: 230, techName: 'Fan_Level_W', nature: 'Enum' },
    { slug: 'consigne.temperature', label: 'Consigne température', dataType: 'Consigne', direction: 'write', unit: '°C', position: 240, techName: 'Setpoint_Temp_W', nature: 'Numérique' },
  ],
};
