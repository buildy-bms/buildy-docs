...
`.trim(),
  points: [
    ...
    { slug: 'energie.produite_jour', label: 'Énergie produite (jour)', dataType: 'Mesure', direction: 'read', unit: 'kWh', position: 40, isOptional: true, nature: 'Numérique' },
    { slug: 'energie.injectee_reseau', label: 'Énergie injectée au réseau', dataType: 'Mesure', direction: 'read', unit: 'kWh', position: 50, isOptional: true, nature: 'Numérique' },
    ...
    { slug: 'alarme.defaut_isolation', label: 'Défaut isolation', dataType: 'Alarme', direction: 'read', position: 100, isOptional: true, nature: 'Booléen' },
    { slug: 'alarme.deconnexion_reseau', label: 'Déconnexion réseau', dataType: 'Alarme', direction: 'read', position: 110, isOptional: true, nature: 'Booléen' },
  ],
};
