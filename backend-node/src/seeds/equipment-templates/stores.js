...
`.trim(),
  points: [
    ...
    { slug: 'mesure.inclinaison_lames', label: 'Inclinaison des lames', dataType: 'Mesure', direction: 'read', unit: '°', position: 20, nature: 'Numérique', techName: 'Position_R' },
    { slug: 'etat.deplacement', label: 'État en cours de déplacement', dataType: 'État', direction: 'read', position: 30, nature: 'Booléen', techName: 'Up_Down_R' },
    { slug: 'alarme.defaut_moteur', label: 'Défaut moteur', dataType: 'Alarme', direction: 'read', position: 40, nature: 'Booléen', techName: 'System_Fault_R' },
    ...
    { slug: 'cmd.inclinaison_lames', label: 'Commande inclinaison des lames', dataType: 'Commande', direction: 'write', unit: '°', position: 140, nature: 'Booléen', techName: 'Position_W' },
  ],
};
