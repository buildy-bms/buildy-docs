...
`.trim(),
  points: [
    ...
    { slug: 'temp.retour_chauffage', label: 'Température retour chauffage', dataType: 'Mesure', direction: 'read', unit: '°C', position: 40, nature: 'Numérique' },
    { slug: 'temp.fumees', label: 'Température fumées', dataType: 'Mesure', direction: 'read', unit: '°C', position: 50, nature: 'Numérique' },
    { slug: 'pression.circuit', label: 'Pression circuit', dataType: 'Mesure', direction: 'read', unit: 'bar', position: 60, nature: 'Numérique' },
    ...
    { slug: 'consigne.depart_effective', label: 'Consigne départ effective', dataType: 'Mesure', direction: 'read', unit: '°C', position: 80, nature: 'Numérique' },
    ...
    { slug: 'alarme.defaut_bruleur', label: 'Défaut brûleur / allumage', dataType: 'Alarme', direction: 'read', position: 120, nature: 'Booléen' },
    { slug: 'alarme.surchauffe', label: 'Alarme surchauffe', dataType: 'Alarme', direction: 'read', position: 130, nature: 'Booléen' },
    ...
    { slug: 'consigne.confort_reduit', label: 'Consigne confort/réduit', dataType: 'Consigne', direction: 'write', position: 230, nature: 'Numérique' },
  ],
};
