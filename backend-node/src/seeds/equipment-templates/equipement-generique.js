...
module.exports = {
  ...
  icon_color: '#6b7280',
  description_html: `
<p>Cette catégorie permet de documenter tout équipement technique non couvert par un template dédié (groupe froid, surpresseur, sonde isolée, automate spécifique, etc.). <strong>La régulation est assurée par l\'équipement lui-même</strong>, via la régulation native du fabricant ou via une régulation portée par l\'intégrateur lors de la mise en service. La solution Buildy supervise les états, mesures et alarmes typiques, et porte les logiques applicatives (programmations horaires, scénarios) en transmettant les commandes appropriées au cas par cas.</p>
`.trim(),
  points: [
