...
<template>
  <div class="max-w-5xl mx-auto">
    ...
    <div class="flex items-end justify-between mb-6">
      ...
      <div class="flex items-center gap-2">
        ...
        <button
          ...
          class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs border border-gray-300 hover:bg-gray-50 text-gray-700"
        >
    ...
    <div v-else-if="!commits.length" class="bg-white border border-gray-200 rounded-none p-12 text-center text-sm text-gray-400">
    ...
    <ol v-else class="relative border-l border-gray-200 ml-3">
      <li v-for="(c, i) in commits" :key="c.sha" class="mb-5 ml-5">
        ...
        <div :class="['bg-white border rounded-none p-3', selectedSet.has(c.sha) ? 'border-indigo-400 ring-1 ring-indigo-200' : 'border-gray-200']">
