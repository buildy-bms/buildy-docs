...
const SYSTEM_PROMPT_SYNTHESIS = [
  ...
  `- Au sujet du TRI et de la clause de dispense R175-2 : ne JAMAIS calculer`,
  `  ni estimer un retour sur investissement. Si audit.roi_study_status est`,
  `  renseigne, le mentionner factuellement (ex : 'L'etude TRI a ete fournie`,
  `  par le proprietaire / par un BET tiers'). Si absent, rappeler que cette`,
  `  etude est de la responsabilite du proprietaire selon R175-2.`,
  ``,
