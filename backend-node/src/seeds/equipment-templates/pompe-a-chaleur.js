...
`.trim(),
  points: [
    ...
    { slug: 'temp.depart_eau', label: 'Température eau de départ', dataType: 'Mesure', direction: 'read', unit: '°C', position: 20, techName: 'Supply_Water_Temp_R', nature: 'Numérique' },
    { slug: 'temp.retour_eau', label: 'Température eau de retour', dataType: 'Mesure', direction: 'read', unit: '°C', position: 30, isOptional: true, techName: 'Return_Water_Temp_R', nature: 'Numérique' },
    { slug: 'temp.exterieure', label: 'Température extérieure (source)', dataType: 'Mesure', direction: 'read', unit: '°C', position: 40, techName: 'Outside_Air_Temp_R', nature: 'Numérique' },
    { slug: 'consigne.temperature_effective', label: 'Consigne température effective', dataType: 'Mesure', direction: 'read', unit: '°C', position: 50, techName: 'Setpoint_Temp_R', nature: 'Numérique' },
    { slug: 'etat.mode_chaud_froid', label: 'Mode chaud/froid', dataType: 'État', direction: 'read', position: 60, techName: 'Heat_Cool_Mode_R', nature: 'Booléen' },
    ...
    { slug: 'consigne.temperature', label: 'Consigne température', dataType: 'Consigne', direction: 'write', unit: '°C', position: 220, techName: 'Setpoint_Temp_W', nature: 'Numérique' },
  ],
};
