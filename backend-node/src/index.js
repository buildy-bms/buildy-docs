...
async function main() {
  ...
  await fastify.register(require('./routes/bacs-articles'), { prefix: '/api' });
  await fastify.register(require('./routes/bacs-knowledge'), { prefix: '/api' });
  ...
  await fastify.register(require('./routes/maintenance-reports'), { prefix: '/api' });
